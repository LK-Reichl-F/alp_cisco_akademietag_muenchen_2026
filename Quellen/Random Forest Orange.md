...
source: "https://orangedatamining.com/widget-catalog/model/randomforest/"
author:
...
[![](https://orangedatamining.com/widget-catalog/model/images/__optimized-images__/RandomForest.png)](https://orangedatamining.com/widget-catalog/model/images/__optimized-images__/RandomForest.png)
...
Random Forest can be used with Rank for feature scoring. See [Learners as Scorers](https://orangedatamining.com/learners-as-scorers/index) for an example.

## Examples

For classification tasks, we use *iris* dataset. Connect it to [Predictions](https://orangedatamining.com/widget-catalog/evaluate/predictions). Then, connect [File](https://orangedatamining.com/widget-catalog/model/data/file.md) to **Random Forest** and [Tree](https://orangedatamining.com/widget-catalog/model/model/tree.md) and connect them further to [Predictions](https://orangedatamining.com/widget-catalog/evaluate/predictions). Finally, observe the predictions for the two models.

[![](https://orangedatamining.com/widget-catalog/model/images/__optimized-images__/RandomForest-classification.png)](https://orangedatamining.com/widget-catalog/model/images/__optimized-images__/RandomForest-classification.png)

For regressions tasks, we will use *housing* data. Here, we will compare different models, namely **Random Forest**, [Linear Regression](https://orangedatamining.com/widget-catalog/model/model/linearregression.md) and [Constant](https://orangedatamining.com/widget-catalog/model/model/constant.md), in the [Test & Score](https://orangedatamining.com/widget-catalog/evaluate/testandscore) widget.

[![](https://orangedatamining.com/widget-catalog/model/images/__optimized-images__/RandomForest-regression.png)](https://orangedatamining.com/widget-catalog/model/images/__optimized-images__/RandomForest-regression.png)
